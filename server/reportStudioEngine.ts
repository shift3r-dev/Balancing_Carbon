...
export async function createStudioPptx(report: any) {
  const PptxConstructor: typeof PptxGenJS = (PptxGenJS as any).default ?? PptxGenJS; const pptx = new PptxConstructor(); pptx.layout = 'LAYOUT_WIDE'; pptx.author = 'Balancing Carbon'; pptx.subject = report.type; pptx.title = report.title;
