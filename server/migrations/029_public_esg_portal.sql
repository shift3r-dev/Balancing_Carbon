...
insert into entitlements(id,category_id,key,name,description) values ('ent-public-esg-portal','cat-reports','public.portal','Public ESG Portal','Publish governed carbon, ESG, target, report, certificate, policy and commitment snapshots.') on conflict(id) do update set category_id=excluded.category_id,name=excluded.name,description=excluded.description;
