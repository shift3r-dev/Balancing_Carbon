...
insert into plans (id, name, slug, description, monthly_price, yearly_price, currency, trial_days, recommended, badge, active, sort_order) values
  ('plan-starter', 'Starter', 'starter', 'Carbon accounting essentials for a single organisation.', 0, 0, 'USD', 14, false, '', true, 1),
  ('plan-professional', 'Professional', 'professional', 'Operational carbon intelligence for growing teams.', 0, 0, 'USD', 14, true, 'Most Popular', true, 2),
  ('plan-enterprise', 'Enterprise', 'enterprise', 'Enterprise governance, integrations, and analytics.', 0, 0, 'USD', 14, false, '', true, 3),
  ('plan-enterprise-plus', 'Enterprise+', 'enterprise-plus', 'Custom infrastructure and services for complex deployments.', 0, 0, 'USD', 14, false, 'Custom', true, 4)
on conflict (id) do update set name=excluded.name, slug=excluded.slug, description=excluded.description, recommended=excluded.recommended, badge=excluded.badge, sort_order=excluded.sort_order;

insert into plan_limits (id, plan_id, limit_key, value_type, numeric_value, display_value, unit) values
  ('limit-starter-orgs','plan-starter','organizations','number',1,'1','organization'), ('limit-starter-facilities','plan-starter','facilities','number',3,'3','facilities'), ('limit-starter-users','plan-starter','users','number',5,'5','users'), ('limit-starter-storage','plan-starter','storage_gb','number',5,'5 GB','storage'), ('limit-starter-reports','plan-starter','reports_month','number',10,'10','reports/month'), ('limit-starter-ai','plan-starter','ai_requests_month','number',500,'500','requests/month'), ('limit-starter-api','plan-starter','api_calls_day','number',0,'0','calls/day'),
  ('limit-pro-orgs','plan-professional','organizations','number',1,'1','organization'), ('limit-pro-facilities','plan-professional','facilities','unlimited',null,'Unlimited','facilities'), ('limit-pro-users','plan-professional','users','number',25,'25','users'), ('limit-pro-storage','plan-professional','storage_gb','number',100,'100 GB','storage'), ('limit-pro-reports','plan-professional','reports_month','unlimited',null,'Unlimited','reports'), ('limit-pro-ai','plan-professional','ai_requests_month','number',10000,'10,000','requests/month'), ('limit-pro-api','plan-professional','api_calls_day','number',50000,'50,000','calls/day'),
  ('limit-enterprise-orgs','plan-enterprise','organizations','number',1,'1','organization'), ('limit-enterprise-facilities','plan-enterprise','facilities','unlimited',null,'Unlimited','facilities'), ('limit-enterprise-users','plan-enterprise','users','unlimited',null,'Unlimited','users'), ('limit-enterprise-storage','plan-enterprise','storage_gb','number',1024,'1 TB','storage'), ('limit-enterprise-reports','plan-enterprise','reports_month','unlimited',null,'Unlimited','reports'), ('limit-enterprise-ai','plan-enterprise','ai_requests_month','unlimited',null,'Unlimited','requests'), ('limit-enterprise-api','plan-enterprise','api_calls_day','unlimited',null,'Unlimited','calls'),
  ('limit-plus-orgs','plan-enterprise-plus','organizations','custom',null,'Custom','organizations'), ('limit-plus-facilities','plan-enterprise-plus','facilities','custom',null,'Custom','facilities'), ('limit-plus-users','plan-enterprise-plus','users','custom',null,'Custom','users'), ('limit-plus-storage','plan-enterprise-plus','storage_gb','custom',null,'Custom','storage'), ('limit-plus-reports','plan-enterprise-plus','reports_month','custom',null,'Custom','reports'), ('limit-plus-ai','plan-enterprise-plus','ai_requests_month','custom',null,'Custom','requests'), ('limit-plus-api','plan-enterprise-plus','api_calls_day','custom',null,'Custom','calls')
...
select 'feature-' || plan_id || '-' || feature_key, plan_id, feature_key, label, category, availability, sort_order from (values
 ...
 ('plan-professional','advanced_dashboard','Advanced Dashboard','Analytics','included',1), ('plan-professional','ai_insights','AI Insights','AI','included',2), ('plan-professional','carbon_intelligence','Carbon Intelligence','Carbon Accounting','included',3), ('plan-professional','benchmarking','Benchmarking','Analytics','included',4), ('plan-professional','projects','Projects','Projects','included',5), ('plan-professional','compliance','Compliance','Compliance','included',6), ('plan-professional','rest_api','REST API','Integrations','included',7), ('plan-professional','priority_support','Priority Support','Support','included',8),
 ('plan-enterprise','custom_roles','Custom Roles','Security','included',1), ('plan-enterprise','erp_integrations','ERP Integrations','Integrations','included',2), ('plan-enterprise','sso','SSO','Security','included',3), ('plan-enterprise','scim','SCIM','Security','included',4), ('plan-enterprise','audit_logs','Audit Logs','Security','included',5), ('plan-enterprise','advanced_analytics','Advanced Analytics','Analytics','included',6), ('plan-enterprise','forecasting','Forecasting','Analytics','included',7), ('plan-enterprise','white_label','White Label','Administration','included',8), ('plan-enterprise','success_manager','Dedicated Success Manager','Support','included',9),
 ('plan-enterprise-plus','private_ai','Private AI','AI','custom',1), ('plan-enterprise-plus','dedicated_cloud','Dedicated Cloud','Infrastructure','custom',2), ('plan-enterprise-plus','dedicated_database','Dedicated Database','Infrastructure','custom',3), ('plan-enterprise-plus','dedicated_gpu','Dedicated GPU','Infrastructure','custom',4), ('plan-enterprise-plus','custom_modules','Custom Modules','Administration','custom',5), ('plan-enterprise-plus','sla_24_7','24x7 SLA','Support','custom',6), ('plan-enterprise-plus','professional_services','Professional Services','Support','custom',7)
